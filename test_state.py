...
from slimevolleygym.neat import NeatModel, makeSlimeNeatPolicy
...
if __name__=="__main__":
  ...
  policy = makeSlimeNeatPolicy("neat_bl_p500_multiacts0.3_forehead_gen60/neat_winner.pckl") # defaults to use NEAT agent for player
